...
set output "Highspeed_FairNessIndexVsBottleNeckDataRate.png"
...
plot "Task1_output/HighSpeed_output1.dat" using 1:5 with linespoints lw 1 lc rgb "blue" title "JainIndex"
