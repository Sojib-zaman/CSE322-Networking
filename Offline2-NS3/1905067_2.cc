...
using namespace ns3 ;
NS_LOG_COMPONENT_DEFINE("MobileOffline") ;
...
Sender_mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel", "Bounds", ns3::RectangleValue(ns3::Rectangle(0.0, sqrt(n_nodes), 0.0, sqrt(n_nodes))), "Speed", ns3::StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(speed) + "]"));
...
Receiver_mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel", "Bounds", ns3::RectangleValue(ns3::Rectangle(0.0, sqrt(n_nodes), 0.0, sqrt(n_nodes))), "Speed", ns3::StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(speed) + "]"));
...
Sender_mobility.SetPositionAllocator("ns3::RandomRectanglePositionAllocator",
    "X",
    StringValue("ns3::UniformRandomVariable[Min=0.0|Max=" + std::to_string(n_nodes) + "]"),
    "Y",
    StringValue("ns3::UniformRandomVariable[Min=0.0|Max=" + std::to_string(n_nodes) + "]"));
...
Sender_mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel", "Bounds", ns3::RectangleValue(ns3::Rectangle(0.0, n_nodes, 0.0, n_nodes)), "Speed", ns3::StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(speed) + "]"));
...
Receiver_mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel", "Bounds", ns3::RectangleValue(ns3::Rectangle(0.0, n_nodes, 0.0, n_nodes)), "Speed", ns3::StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(speed) + "]"));
Receiver_mobility.Install(Y_nR_st_nodes);
